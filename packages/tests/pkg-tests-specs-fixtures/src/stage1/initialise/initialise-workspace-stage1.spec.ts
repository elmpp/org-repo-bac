...
describe("initialise workspace", () => {
  ...
  it.only("creates a skeleton workspace without configPath using skeleton config - cliRegistry", async () => {
  ...
  it.only("creates a skeleton workspace without configPath using skeleton config - linked", async () => {
    await run((testContext) => [
      "initialise",
      "workspace",
      "--name",
