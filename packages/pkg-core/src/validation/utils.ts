import { z } from "zod"
import { LifecycleImplementedMethods, LifecycleOptionsByMethodKeyedByProviderWithoutCommonSingular, LifecycleReturnByMethodArray, LifecycleReturnByMethodSingular } from "../__types__/lifecycles"

export const providerOptionsSchemaBuilder = <LMethod extends LifecycleImplementedMethods = LifecycleImplementedMethods, PType = LifecycleOptionsByMethodKeyedByProviderWithoutCommonSingular<LMethod>>(_lifecycleMethod: LMethod) => {
  return z.object({
    provider: z.string(),
    options: z.object({
    }),
...
export const providerReturnOptionsSchemaBuilderArray = <LMethod extends LifecycleImplementedMethods = LifecycleImplementedMethods>(_lifecycleMethod: LMethod) => {
...
export const providerReturnOptionsSchemaBuilderSingular = <LMethod extends LifecycleImplementedMethods = LifecycleImplementedMethods>(_lifecycleMethod: LMethod) => {
  return z.object({
    provider: z.string(),
    options: z.object({}),
  // })
  // }) as unknown as z.ZodType<PType, z.ZodTypeDef>
  }) as unknown as z.ZodType<LifecycleReturnByMethodSingular<LMethod>, z.ZodTypeDef>
}
