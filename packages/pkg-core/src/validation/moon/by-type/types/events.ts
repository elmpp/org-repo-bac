...
export type PayloadActionStarted = WebhookPayload<
  'action.started',
  EventActionStarted
>
...
export type PayloadActionFinished = WebhookPayload<
  'action.finished',
  EventActionFinished
>
...
export type PayloadProjectSyncing = WebhookPayload<
  'project.syncing',
  EventProjectSyncing
>
...
export type PayloadProjectSynced = WebhookPayload<
  'project.synced',
  EventProjectSynced
>
...
export type PayloadPipelineAborted = WebhookPayload<
  'pipeline.aborted',
...
export type PayloadPipelineStarted = WebhookPayload<
  'pipeline.started',
...
export type PayloadPipelineFinished = WebhookPayload<
  'pipeline.finished',
...
export type PayloadTargetRunning = WebhookPayload<
  'target.running',
  EventTargetRunning
>
...
export type PayloadToolInstalling = WebhookPayload<
  'tool.installing',
  EventToolInstalling
>
...
export type PayloadToolInstalled = WebhookPayload<
  'tool.installed',
  EventToolInstalled
>
