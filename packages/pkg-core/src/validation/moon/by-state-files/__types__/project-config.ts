...
import {
  ...
  projectMetadataConfigSchema,
  projectToolchainConfigSchema,
  projectToolchainNodeConfigSchema,
  projectToolchainTypeScriptConfigSchema,
  projectTypeSchema,
  projectWorkspaceConfigSchema,
  taskConfigSchema,
  taskMergeStrategySchema,
  taskOptionsConfigSchema,
  taskOutputStyleSchema
} from '../project-config'
...
export type MoonProjectMetadataConfig = z.infer<
  typeof projectMetadataConfigSchema
>
export type MoonProjectToolchainNodeConfig = z.infer<
  typeof projectToolchainNodeConfigSchema
>
export type MoonProjectToolchainTypeScriptConfig = z.infer<
  typeof projectToolchainTypeScriptConfigSchema
>
export type MoonProjectToolchainConfig = z.infer<
  typeof projectToolchainConfigSchema
>
export type MoonProjectWorkspaceConfig = z.infer<
  typeof projectWorkspaceConfigSchema
>
export type MoonProjectConfig = z.infer<typeof projectConfigSchema>
export type MoonInheritedTasksConfig = z.infer<
  typeof inheritedTasksConfigSchema
>
