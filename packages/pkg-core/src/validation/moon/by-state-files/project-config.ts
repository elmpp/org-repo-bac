...
export const taskOptionsConfigSchema = z
  .object({
    affectedFiles: z
...
export const projectMetadataConfigSchema = z
  .object({
    name: z.string(),
...
export const projectToolchainNodeConfigSchema = z
  .object({
    version: z.string().optional()
  })
  .strict()

export const projectToolchainTypeScriptConfigSchema = z
  .object({
...
export const projectToolchainConfigSchema = z
  .object({
...
export const projectWorkspaceConfigSchema = z
  .object({
...
export const inheritedTasksConfigSchema = z
  .object({
