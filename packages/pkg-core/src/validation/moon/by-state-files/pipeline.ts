...
export const actionNodeInstallDepsSchema = z
  .object({
...
export const actionNodeInstallProjectDepsSchema = z
  .object({
...
export const actionNodeRunTargetSchema = z
  .object({
...
export const actionNodeSetupToolSchema = z
  .object({
...
export const actionNodeSyncProjectSchema = z
  .object({
