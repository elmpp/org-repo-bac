...
export type ExcludeMatchingProperties<T extends Record<string, any>, V> = Pick<T, {[K in keyof T]-?: T[K] extends V ? never : K}[keyof T]>
export type IncludeMatchingProperties<T extends Record<string, any>, V> = Pick<T, {[K in keyof T]-?: T[K] extends V ? K : never}[keyof T]>
