...
export type ExcludeMatchingProperties<T extends Record<string, any>, V> = Pick<T, {[K in keyof T]-?: V extends T[K] ? never : K}[keyof T]> // see test in ./util.spec!!
export type IncludeMatchingProperties<T extends Record<string, any>, V> = Pick<T, {[K in keyof T]-?: V extends T[K] ? K : never}[keyof T]> // see test in ./util.spec!!
...
export type NullishToOptional<T extends Record<string, any>> = Partial<IncludeMatchingProperties<T, undefined>> & ExcludeMatchingProperties<T, undefined>
