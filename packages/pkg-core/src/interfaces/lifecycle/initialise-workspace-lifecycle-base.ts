...
export class InitialiseWorkspaceLifecycleBase<
  T extends
    LifecycleStaticInterface = typeof InitialiseWorkspaceLifecycleBase<any>
> {
  ...
  static hooks = {
    beforeInitialiseWorkspace: new AsyncHook<'initialiseWorkspace'>(
      ['options'],
      'initialiseWorkspace',
      'beforeInitialiseWorkspace'
    ),
    initialiseWorkspace: new AsyncHook<'initialiseWorkspace'>(
      ['options'],
      'initialiseWorkspace',
      'initialiseWorkspace'
    ),
    afterInitialiseWorkspace: new AsyncHook<'initialiseWorkspace'>(
      ['options'],
      'initialiseWorkspace',
      'afterInitialiseWorkspace'
    )
  }
