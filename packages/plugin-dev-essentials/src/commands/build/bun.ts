 ...
 */
export default class BunSnapshot extends BaseCommand<typeof BunSnapshot> {
  static override description = "Creates a local snapshot bun";
...
`,
  ...
  async execute(context: ContextCommand<typeof BunSnapshot>) {
