...
export type AddressTypeByGroup<TGroup extends AddressGroupUnion> = ValueOf<ExcludeMatchingProperties<{
  [AddType in keyof AddressType]: AddressType[AddType][1] extends TGroup ? AddType & keyof AddressType : never
}, never>>
