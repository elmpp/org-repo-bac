...
import "./git-http-repo-url-handler";
import "./git-ssh-repo-url-handler";
import "./url-handler";
...
import { handler as gitHttpRepoUrlHandler } from "./git-http-repo-url-handler";
import { handler as gitSshRepoUrlHandler } from "./git-ssh-repo-url-handler";
...
export const handlers = [
  ...
  githubUrlHandler,
  gitHttpRepoUrlHandler,
  gitSshRepoUrlHandler,
  urlHandler, // default
